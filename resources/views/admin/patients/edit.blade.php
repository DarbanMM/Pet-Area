...
@section('title', 'Edit Pasien - Admin')

@section('content')
    <h2 class="text-3xl font-semibold text-gray-800 mb-6">Edit Data Pasien: {{ $patient->name }}</h2>
    ...
    <form action="{{ route('admin.patients.update', $patient->id) }}" method="POST" class="bg-white rounded-lg shadow-md p-6 max-w-2xl mx-auto">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="species" name="species" value="{{ old('species', $patient->species) }}" required
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label for="breed" class="block text-gray-700 text-sm font-bold mb-2">Ras Hewan</label>
                    <input type="text" id="breed" name="breed" value="{{ old('breed', $patient->breed) }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label for="date_of_birth" class="block text-gray-700 text-sm font-bold mb-2">Tanggal Lahir</label>
                    <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $patient->date_of_birth) }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" id="weight" name="weight" value="{{ old('weight', $patient->weight) }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    ...
                    <textarea id="medical_history" name="medical_history" rows="3"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('medical_history', $patient->medical_history) }}</textarea>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="owner_name" name="owner_name" value="{{ old('owner_name', $patient->owner_name) }}" required
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label for="owner_phone" class="block text-gray-700 text-sm font-bold mb-2">No. HP Pemilik</label>
                    <input type="text" id="owner_phone" name="owner_phone" value="{{ old('owner_phone', $patient->owner_phone) }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    ...
                    <textarea id="owner_address" name="owner_address" rows="3"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('owner_address', $patient->owner_address) }}</textarea>
                </div>
                <div class="mb-4">
                    <label for="owner_email" class="block text-gray-700 text-sm font-bold mb-2">Email Pemilik</label>
                    <input type="email" id="owner_email" name="owner_email" value="{{ old('owner_email', $patient->owner_email) }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
            </div>
        </div>
