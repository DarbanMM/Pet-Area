...
@section('title', 'Catat Transaksi Baru - Admin')
@section('header_title', 'Catat Transaksi Baru')

@section('content')
    <h2 class="text-3xl font-semibold text-gray-800 mb-6">Catat Transaksi Pembayaran Baru</h2>
    ...
    <form action="{{ route('admin.transactions.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6 max-w-xl mx-auto">
        @csrf
        <div class="mb-4">
