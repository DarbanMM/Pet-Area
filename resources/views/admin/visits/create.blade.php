...
@section('title', 'Catat Kunjungan Baru - Admin')
@section('header_title', 'Catat Kunjungan Baru')

@section('content')
    <h2 class="text-3xl font-semibold text-gray-800 mb-6">Catat Kunjungan Pasien Baru</h2>
    ...
    <form action="{{ route('admin.visits.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6 max-w-xl mx-auto">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-6">
            ...
            <select id="status" name="status" required
                ...
                <option value="canceled" {{ old('status') == 'canceled' ? 'selected' : '' }}>Dibatalkan (Canceled)</option>
            </select>
        </div>
        <div class="mb-4">
